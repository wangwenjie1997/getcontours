...
public class Demo {
    ...
    public Demo(String dllPath){
        System.load(dllPath);
    }

    public static void main(String[] args) {
        Demo demo=new Demo("D:\\Program Files\\opencv\\build\\java\\x64\\opencv_java401.dll");
        //读入图片
        Mat src = Imgcodecs.imread("F:\\opencvPhoto\\photo\\53.jpg");
